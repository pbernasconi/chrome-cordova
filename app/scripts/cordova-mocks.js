...
device = {
    cordova: '3.5.0',
    model: 'iPhone 5,1',
    name: 'iPhone 5,1 - deprecated',
    platform: 'iOS',
    uuid: '599F9C00-92DC-4B5C-9464-7971F01F8370',
    version: '7.1'
};
...
accelerometer.watchAcceleration = function () {
...
globalization.getPreferredLanguage = function (success, error) {
    return  {
        value: "EN"
    };
};
...
Object.defineProperty(window, 'device', device);
navigator.accelerometer = accelerometer;
window.navigator.camera = camera;
window.Camera = cameraOptions;
window.navigator.connection = connection;
window.Connection = connectionOptions;
window.navigator.globalization = globalization;
//Object.defineProperty(window.navigator, 'globalization', globalization);
